...
import tambahAnggotaRuangManual from '../pages/Ruang/tambahAnggotaRuangManual';
...
var routes = [
  ...
  {
    path: '/tambahAnggotaRuangManual/:ruang_id/:sekolah_id',
    component: tambahAnggotaRuangManual
  },
  {
