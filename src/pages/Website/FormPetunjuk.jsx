...
class FormPetunjuk extends Component {
    state = {
        error: null,
        loading: false,
        routeParams: {
    ...
    render()
    {
        ...
        return (
            <Page name="FormPetunjuk" hideBarsOnScroll>
                <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}>
                    <NavTitle sliding>Kelola Artikel Petunjuk Transaksi</NavTitle>
                </Navbar>
...
export default (connect(mapStateToProps, mapDispatchToProps)(FormPetunjuk));
