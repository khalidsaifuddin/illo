...
class FormTimMarketing extends Component {
    state = {
        error: null,
        loading: true,
        routeParams:{
    ...
    pilihPengguna = (pengguna) => {
        ...
        this.props.simpanTimMarketing({
            ...
            if(result.payload.sukses){
                //berhasil
                this.$f7.dialog.close()
                this.$f7.dialog.alert('Berhasil menambahkan tim marketing', 'Berhasil', ()=>{
                    this.$f7router.navigate('/TimMarketing/')
                })
            }else{
                //gagal
                this.$f7.dialog.close()
    ...
    {
        return (
            <Page name="FormTimMarketing" hideBarsOnScroll>
                <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}>
                    <NavTitle sliding>Tambah Tim Marketing</NavTitle>
                </Navbar>
...
export default (connect(mapStateToProps, mapDispatchToProps)(FormTimMarketing));
