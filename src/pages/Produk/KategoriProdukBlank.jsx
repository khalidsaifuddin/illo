...
class KategoriProdukBlank extends Component {
    state = {
        error: null,
        loadingKuis: false,
    ...
    {
        return (
            <Page name="KategoriProdukBlank" className="halamanJenisTiket" hideBarsOnScroll style={{marginBottom:'100px', boxSizing:'content-box'}}>
...
export default (connect(mapStateToProps, mapDispatchToProps)(KategoriProdukBlank));
