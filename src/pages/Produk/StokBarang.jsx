...
class StokBarang extends Component {
    ...
    {
        return (
            <Page name="StokBarang" className="halamanJenisTiket" hideBarsOnScroll style={{marginBottom:'100px', boxSizing:'content-box'}}>
                <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}>
                    <NavTitle sliding>Stok Barang</NavTitle>
                </Navbar>
...
export default (connect(mapStateToProps, mapDispatchToProps)(StokBarang));
