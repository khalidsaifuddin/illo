...
class CariProduk extends Component {
    ...
    {
        return (
            <Page name="CariProduk" className="halamanJenisTiket" hideBarsOnScroll style={{marginBottom:'100px', boxSizing:'content-box'}}>
                <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}>
                    <NavTitle sliding>Cari Produk</NavTitle>
                </Navbar>
...
export default (connect(mapStateToProps, mapDispatchToProps)(CariProduk));
